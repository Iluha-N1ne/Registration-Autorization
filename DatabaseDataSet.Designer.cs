...
namespace RegistrationMark2 {
    ...
    public partial class DatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow AddUsersRow(string Login, string Hash, string Salt) {
...
namespace RegistrationMark2.DatabaseDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Users` WHERE ((`ID` = ?) AND ((? = 1 AND `Login` IS NULL) OR (`Login" +
                "` = ?)) AND ((? = 1 AND `Hash` IS NULL) OR (`Hash` = ?)) AND ((? = 1 AND `Salt` " +
                "IS NULL) OR (`Salt` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Users` (`Login`, `Hash`, `Salt`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Users` SET `Login` = ?, `Hash` = ?, `Salt` = ? WHERE ((`ID` = ?) AND ((? " +
                "= 1 AND `Login` IS NULL) OR (`Login` = ?)) AND ((? = 1 AND `Hash` IS NULL) OR (`" +
                "Hash` = ?)) AND ((? = 1 AND `Salt` IS NULL) OR (`Salt` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::RegistrationMark2.Properties.Settings.Default.DatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Login, Hash, Salt FROM Users";
        ...
        public virtual int Delete(int Original_ID, string Original_Login, string Original_Hash, string Original_Salt) {
        ...
        public virtual int Insert(string Login, string Hash, string Salt) {
            if ((Login == null)) {
        ...
        public virtual int Update(string Login, string Hash, string Salt, int Original_ID, string Original_Login, string Original_Hash, string Original_Salt) {
            if ((Login == null)) {
            ...
            if ((Original_Hash == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_Hash));
            }
            if ((Original_Salt == null)) {
